...
//Text
$_['text_edit'] = 'Edit Worldline Checkout';
$_['text_extension'] = 'Extensions';
$_['text_home'] = 'Home';
$_['text_success'] = 'Success: You have modified Worldline Checkout settings!';
...
$_['text_no'] = 'No';
$_['text_yes'] = 'Yes';
$_['text_goto_bambora_admin'] = 'Go to Merchant Administration';
$_['text_capture_info_collector'] = 'With Payment Provider Walley only full capture is possible here. For partial capture, please use Merchant Portal.';
$_['text_refund_info_collector'] = 'With Payment Provider Walley only full refund is possible here. For partial refund, please use Merchant Portal.';
...
// Help
$_['help_status'] = 'Enable / Disable the Worldline Checkout payment gateway';
$_['help_merchant'] = 'The number identifying your Worldline merchant account.';
$_['help_access_token'] = 'The Access token for the API user received from the Worldline administration.';
$_['help_secret_token'] = 'The Secret token for the API user received from the Worldline administration.';
$_['help_md5'] = 'The MD5 key is used to stamp data sent between OpenCart and Worldline to prevent it from being tampered with. The MD5 key is optional but if used here, must be the same as in the Worldline administration.';
...
$_['help_payment_method_update'] = 'Update the payment method title on the order with the one choosen in payment window (t.ex. to \'Worldline - Visa (Debit / Domestic)\'), overwriting the title defined above.';
...
//Error
$_['error_permission'] = 'Warning You do not have permission to modify Worldline Checkout!';
...
$_['error_get_api_error'] = 'No connection to Worldline';
